...
<html lang="nl">
  ...
  <ul class="nav">
    ...
    <div class="container  text-center">
        <div class="row">
           <div class="col">
               <h1>Goedemiddag, welkom bij ZuZu</h1>
               <p class="text">Wij zijn gespecialiseerd in de keuken.
                   <br>
      ...
      <div class="row">
          <div class="col-6">
              <div class="card" style="">
                  <img src="img/shushi1.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
          ...
          <div class="col-6">
              <div class="card" style="">
                  <img src="img/sushi2.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
